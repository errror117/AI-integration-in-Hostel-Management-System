...
import EditStudent from "./components/Dashboards/AdminDashboard/EditStudent";
import StudentQR from "./components/Dashboards/StudentDashboard/StudentQR";
import Analytics from "./components/Dashboards/AdminDashboard/Analytics";
import ChatWindow from "./components/Chatbot/ChatWindow";
import SuperAdminDashboard from "./components/SuperAdmin/SuperAdminDashboard";
// import AdminQRScanner from "./components/Dashboards/AdminDashboard/AdminQRScanner";
      ...
      <SocketProvider>
        ...
        <Routes>
          ...
          <Route path="/admin-dashboard" element={<AdminIndex />}>
            ...
            <Route path="chatbot-analytics" element={<Analytics />} />
